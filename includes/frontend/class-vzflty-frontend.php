	...
	private function prepare_script_data( $options ) {
		...
		return array(
			...
			'i18n'            => array(
				...
				'formTitle'            => vzflty_get_option_value( $options, 'i18n_form_title', __( 'Almost there!', 'floaty-book-now-chat' ) ),
				'formSubtitle'         => vzflty_get_option_value( $options, 'i18n_form_subtitle', __( 'Fill in your details and go straight to our WhatsApp.', 'floaty-book-now-chat' ) ),
				'formNamePlaceholder'  => vzflty_get_option_value( $options, 'i18n_name_placeholder', __( 'Name', 'floaty-book-now-chat' ) ),
				'formEmailPlaceholder' => vzflty_get_option_value( $options, 'i18n_email_placeholder', __( 'Email', 'floaty-book-now-chat' ) ),
				'formPhonePlaceholder' => vzflty_get_option_value( $options, 'i18n_phone_placeholder', __( 'Phone', 'floaty-book-now-chat' ) ),
				'formSubmitLabel'      => vzflty_get_option_value( $options, 'i18n_submit_label', __( 'Send', 'floaty-book-now-chat' ) ),
				'formSuccessMessage'   => vzflty_get_option_value( $options, 'i18n_success_message', __( 'Thank you! Redirecting...', 'floaty-book-now-chat' ) ),
